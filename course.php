...
$courseDisplayQuery= " SELECT * FROM courses";
$displayQuery = mysqli_query($connection, $courseDisplayQuery);
...
<div class="card" style="height:300px">
      ...
      <div class="card-body">
        ...
        <h6><?php echo "$about"; ?></h6>
          <h4 class="card-title">Instructor: <?php echo "$instructorName"; ?></h4>
        <div class="card-content">

          <div class="form-field col-lg-12">
            <input type="hidden" name="course_id" value="<?php echo $id ?>">
           <input class="submit-btn text-center" type="submit" value="BuyNow" name="buyNow" >
       </div>
        </div>
      </div>
    </div>
...
if(isset($_POST['buyNow'])){
  if(isset($_SESSION['user_id'])){
    ...
    $q1 = "SELECT * FROM coursebuy WHERE course_id = '$courseId' AND user_id={$_SESSION['user_id']} ";
    $r1 = mysqli_query($connection,$q1);
    if($r1->num_rows==0){


    $insertCourse = "INSERT INTO coursebuy (user_id, course_id) VALUES ('$activeUser', '$courseId')";

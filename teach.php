...
<html lang="en" dir="ltr">
  ...
  <a href="profilePage.php" style="padding:2px;"><?php include "currentUser.php" ?></a>
    ...
    <div class="mainHeading" style="margin-top:100px;">
      <h1 class="subHeading">You can also be an instructor!!</h1>
    </div>




    <section class="get-in-touch" style="margin-top:70px;">
      
       <form class="contact-form row" action="createCourse.php" method="post">
          ...
          <div class="form-field col-lg-6 ">
             <input id="company" class="input-text js-input" type="Number" required>
             <label class="label" for="company">Age:</label>
          </div>
           <div class="form-field col-lg-6 ">
          ...
          <div class="form-field col-lg-12">
             ...
             <label class="label" for="message">What inspires you to teach music?</label>
          </div>
          <div class="form-field col-lg-12">
             <a href="createCourse.php" class="submit-btn text-center" type="submit" value="Submit" >Submit</a>
          </div>
       </form>
    </section>

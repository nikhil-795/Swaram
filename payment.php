                        ...
                        <div class="card rounded-0 border-0 card1" id="bill">
                            ...
                            <div class="row">
                                <div class="col-lg-7 col-8 mt-4 line pl-4">
                                    <h2 class="bill-head">Electronics</h2> <small class="bill-date"></small>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-7 col-8 mt-4 line pl-4">
                                    <h2 class="bill-head">Food</h2> <small class="bill-date"></small>
                                </div>
                                <div class="col-lg-5 col-4 mt-4">
                            ...
                            <div class="row">
                                <div class="col-lg-7 col-8 mt-4 line pl-4">
                                    <h2 class="bill-head"></h2> <small class="bill-date"></small><br> <small class="bill-date"> </small>
                                </div>
                                <div class="col-lg-5 col-4 mt-4">
                            ...
                            <div class="row">
                                <div class="col-lg-7 col-8 mt-4 line pl-4">
                                    <h2 class="bill-head">Accessories</h2> <small class="bill-date"></small>
                                </div>
                                <div class="col-lg-5 col-4 mt-4">
                                    <h2 class="bill-head px-xl-5 px-lg-4">JFK</h2>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 red-bg">
                                    ...
                                    <h2 class="bill-head" id="total">Rs 1500/-</h2> <small class="bill-date" id="total-label">For the above course</small>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-7 col-sm-12 p-0 box">
                        <div class="card rounded-0 border-0 card2" id="paypage">
                            <div class="form-card">
                                ...
                                </div> <label class="pay">Name on Card</label> <input type="text" name="holdername" placeholder="John Smith" required>
                                <div class="row">
                                    <div class="col-8 col-md-6"> <label class="pay">Card Number</label> <input type="text" name="cardno" required id="cr_no" placeholder="0000-0000-0000-0000" minlength="19" maxlength="19"> </div>
                                    <div class="col-4 col-md-6"> <label class="pay">CVV</label> <input type="password" name="cvcpwd" placeholder="&#9679;&#9679;&#9679;" class="placeicon" minlength="3" maxlength="3" required> </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12"> <label class="pay">Expiration Date</label> </div>
                                    <div class="col-md-12"> <input type="text" name="exp" id="exp" placeholder="MM/YY" minlength="5" maxlength="5" required> </div>
                                </div>
                                <div class="row">
                                <div class="form-field col-lg-12">
         <a href="confirm.php" class="submit-btn text-center" type="submit"  value="Submit" >Submit</a>
...
<section class="foot">
<div class=" my-5" style="height:170px;bottom:0;margin-top:30px; width:100%;left:0;">

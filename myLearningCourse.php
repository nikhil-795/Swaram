...
<div class =" background" style="background-image: url('back.jpg');">
...
<div class="row">
  <?php include "db.php";
  $showCourse = "SELECT c.course_id, c.name, c.instructorName, c.image FROM courses c INNER JOIN coursebuy cb ON c.course_id=cb.course_id WHERE user_id='{$_SESSION['user_id']}'";
  $showCourseQuery = mysqli_query($connection, $showCourse);

  while($row=mysqli_fetch_assoc($showCourseQuery)){
...
<div class="card" style="height:300px">
      ...
      <div class="card-body">
        ...
        <div class="card-content">
          <p class="card-text"><h5><?php echo $instructor ?></h5>

        </p>
          <div class="form-field col-lg-12">
            <form action="detailCourse.php" method="post">
              <input type="hidden" name="courseId" value="<?php echo $courseId ?>">
          <input class="submit-btn text-center" type="submit" value="View More" >
          </form>
       </div>
        </div>
      </div>

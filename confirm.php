...
<div class="">
  <div style="text-align:center;margin:100px 300px 80px 300px;">
    <img src="img/tick.png" style="height:250px;width:250px;">
  </div>
  <div class="">
    <h1 class="allHeadingContent">Congratulations! Your payment is successful.</h1>
    <h1 class="allHeadingContent">Happy Practicing</h1>
  </div>
</div>
